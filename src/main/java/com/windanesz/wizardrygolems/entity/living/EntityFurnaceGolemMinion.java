...
public class EntityFurnaceGolemMinion extends EntityColorizedGolemMinion {
	...
	protected void initEntityAI() {
		super.initEntityAI();
		this.tasks.addTask(0, new EntityFurnaceGolemMinion.InertGoal(this));
		this.tasks.addTask(1, new EntityFurnaceGolemMinion.UseFuelGoal(this));
	...
	class UseFuelGoal extends EntityAIBase {
		...
		private final EntityFurnaceGolemMinion golem;

		protected UseFuelGoal(final EntityFurnaceGolemMinion entity) {
			super();
			golem = entity;
		}
	...
	class InertGoal extends EntityAIBase {
		...
		protected InertGoal(final EntityFurnaceGolemMinion entity) {
			super();
			this.setMutexBits(7);
			golem = entity;
		}
