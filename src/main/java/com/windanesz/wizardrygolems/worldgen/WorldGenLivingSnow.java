package com.windanesz.wizardrygolems.worldgen;

import com.google.common.primitives.Ints;
import com.windanesz.wizardrygolems.Settings;
...
public class WorldGenLivingSnow implements IWorldGenerator {
	 ...
	 */
	public void generateSnow(IBlockState state, World world, Random random, int x, int z, int chancesToSpawn, int groupSize){
