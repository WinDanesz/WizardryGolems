...
public class EntityPackedIceGolemMinion extends EntityGolemBaseMinion implements IIceGolem {

	public EntityPackedIceGolemMinion(World world) {
		super(world);
	...
	protected ResourceLocation applyTexture() {
		return makeTexture(WizardryGolems.MODID, "golem_packed_ice");
	}
